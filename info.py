...
API_ID = int(environ.get('21879629'))
API_HASH = os.environ['dcb6bfd6d51a8ff5f6aadb01b9fdd11b']
BOT_TOKEN = os.environ['6135992497:AAHkETqeVK7q7cvkDLL_sWMAXVWrPlVo99U']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5591007272 1105331049').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001519788177').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1105331049').split()]
