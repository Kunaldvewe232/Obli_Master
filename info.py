...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5591007272').split()]
...
DATABASE_NAME = environ.get('DATABASE_URI = environ.get('cluster0', "ObliMaster")
